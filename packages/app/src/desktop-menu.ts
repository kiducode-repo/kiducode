...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "KiduCode Documentation", href: "https://kiducode.com/docs" },
      { type: "item", label: "Support Forum", href: "https://kiducode.com/discord" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/Aromal11534/Kiducode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/Aromal11534/Kiducode/issues/new?template=bug_report.yml",
      },
    ],
  },
]

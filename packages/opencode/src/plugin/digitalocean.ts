...
<html>
  <head>
    <meta charset="utf-8" />
    <title>KiduCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to KiduCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. KiduCode will create a Model Access Key named kiducode-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",

export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av KiduCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av KiduCode er lastet ned. Vil du installere den og starte på nytt?",

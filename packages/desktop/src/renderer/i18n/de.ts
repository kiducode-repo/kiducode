export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von KiduCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von KiduCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",

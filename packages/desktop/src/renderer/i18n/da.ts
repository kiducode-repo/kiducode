export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af KiduCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af KiduCode er blevet downloadet. Vil du installere den og genstarte?",

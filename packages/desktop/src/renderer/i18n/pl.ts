export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji KiduCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} KiduCode. Czy chcesz ją zainstalować i uruchomić ponownie?",

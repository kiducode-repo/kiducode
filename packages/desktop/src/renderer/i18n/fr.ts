export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de KiduCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de KiduCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",

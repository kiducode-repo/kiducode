...
Practical reference for the current tool-migration state in `packages/kiducode`.
...
Tool tests should use the existing Effect helpers in `packages/kiducode/test/lib/effect.ts`:

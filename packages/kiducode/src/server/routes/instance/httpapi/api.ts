...
export const RootHttpApi = HttpApi.make("kiducode-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("kiducode-instance")
...
export const OpenCodeHttpApi = HttpApi.make("kiducode")
